...
<div class="main">
    ...
    <form action="/../WebDevProject/templates/basketTickets.php" method="post">
        <!-- table to display the match tickets avaiable -->
        <!-- table lists the matches avaiable and allows the users to select -->
            <!-- multiples of three types of ticket for each game -->
        ...
        <table>
            ...
            <!-- Displays the opponents, date and three drop down menus that allow -->
                <!-- the user to select multiple tickets for Adult, Student, and Child -->
            <!-- Tickets for multiple matches can be selected at a time-->
